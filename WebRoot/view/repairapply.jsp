...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
           <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href=""><i class="icon-font">&#xe005;</i>维修申请</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<%=basePath%>view/index.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="">维修记录</a><span class="crumb-step">&gt;</span><span>维修申请</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<%=basePath%>RepairAppeal.action" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
							...
							<tr>
                                <th><i class="require-red">*</i>修理厂家：</th>
                                <td>
                                    <input class="common-text required" id="title" name="repairManufacturer" size="50" value="" type="text">
                                </td>
                            </tr>
							
							<tr>
                                <th><i class="require-red">*</i>维修费用：</th>
                                <td>
                                    <input class="common-text required" id="title" name="repairPrice" size="50" value="" type="text">
                                </td>
                            </tr>                          
							
							<tr>
                                <th>维修信息：</th>
                                <td><textarea name="repairInfo" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
