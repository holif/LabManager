...
<head>
	...
	<script type="text/javascript">
		...
		function update_disagree(obj){
			...
			$.ajax({
				type : "post",
				url : "RepairReview!reject.action",
				data : "id=" + id,
				dataType : 'html',
				contentType : "application/x-www-form-urlencoded; charset=utf-8",
				success : function(result) {
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<%=basePath%>view/index.jsp" color="#white">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="">维修记录</a><span class="crumb-step">&gt;</span><span class="crumb-name">维修审批</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="SelectRepair!byKey.action" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="关键字" name="key" value="" id="" type="text"></td>
             ...
             <!-- <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i>批量删除</a> -->
                ...
                <div class="result-content">
                    <table id="table" class="result-tab" width="100%">
                        ...
                        <c:forEach items="${listrepair}" var="info" varStatus="status">
	                        <tr>
	                            <td>${info.id}</td> 
